...
import { memo, useCallback, useState, useEffect } from "react"; // added useEffect
...
function SignupPage() {
  ...
  const [birthDateError, setBirthDateError] = useState(""); // add a birthday error state
  ...
  const validateBirthDate = useCallback((date) => {
    ...
    // Check if user is not too old (e.g., 120 years)
                    ...
                    <div className="form-group">
                      ...
                      <div className="flex items-center border border-gray-300 px-4 py-3 rounded-lg focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-transparent transition-all">
                        ...
                        <input
                          ...
                          required
                          max={new Date().toISOString().split("T")[0]} // This disables future dates in the date picker
