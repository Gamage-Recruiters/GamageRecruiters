...
const PartnersGrid = () => {
  ...
  const partners = [
    ...
    { id: 6, name: "Solex Group", logo: "", category: "Enginnering" },
    { id: 7, name: "Fits Retail", logo: "", category: "Retail" },
    { id: 8, name: "GentXT", logo: "", category: "Accessories" },
    { id: 9, name: "Candy Factory", logo: "", category: "Candy" },
    { id: 10, name: "Transnational Group", logo: "", category: "IT & Software" },
    { id: 11, name: "BCAS Campus", logo: "", category: "Education" },
    { id: 12, name: "DPR", logo: "", category: "Business Consultant" },
    { id: 13, name: "Anverally Tea", logo: "", category: "Tea Store" },
    { id: 14, name: "Lalan Engineering", logo: "", category: "Enginnering" },
    { id: 15, name: "TukTuk", logo: "", category: "Travel" },
    { id: 16, name: "Captial One", logo: "", category: "Finance" },
    { id: 17, name: "LLP Rodrigo & Sons", logo: "", category: "Plastic" },
    { id: 18, name: "Gajma", logo: "", category: "Tax Consultant" },
    { id: 19, name: "Lumala", logo: "", category: "Bicycle" },
    { id: 20, name: "Trident Corporation", logo: "", category: "IT" },
    { id: 21, name: "Transocean Duty Free", logo: "", category: "Shopping" },
    { id: 22, name: "Stalione Lanka", logo: "", category: "Business management" },
    { id: 23, name: "Prime Group", logo: "", category: "Residencies" },
    { id: 24, name: "SriTrims Limited", logo: "", category: "Garment Exporter" },
    { id: 25, name: "Antler Group", logo: "", category: "Fabric" },
